...
public class FuelWatchRSSParser {
	...
	public static List<Shop> parse(final InputStream in) throws Exception {
				...
				try {
					...
					if (name.equalsIgnoreCase(ITEM)) {
						...
						if (name.equalsIgnoreCase(PRICE)) {
							...
							shop.latitude(Double.parseDouble(parser.nextText()));
						} else if (name.equalsIgnoreCase(LON)) {
							shop.longitude(Double.parseDouble(parser.nextText()));
